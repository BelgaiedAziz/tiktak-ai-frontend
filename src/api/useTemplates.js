...
export const useTemplates = (filters = {}, token) => {
   ...
   * Useful for finding both system and custom templates.
   * @param {string} category - Template category
   * @param {string} subKey - Sub-key identifier
   * @param {string} language - Language code
   * @returns {Array} Array of matching templates (system first, then custom)
   */
  const findTemplates = (category, subKey, language) => {
    return templates.filter(t =>
      ...
      // System templates (is_default=true) come first
   ...
   * @param {string} subKey - Sub-key identifier
   * @param {string} language - Language code
   * @returns {Object|null} System template or null
   */
   ...
   * @param {string} subKey - Sub-key identifier
   * @param {string} language - Language code
   * @returns {Object|null} Custom template or null
   */
